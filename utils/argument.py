...
def add_shared_args(parser):
    ...
    parser.add_argument('--lr-decay-freq', type=int, default=400,
    ...
    parser.add_argument('--pgd-random-start', action='store_true',
                        help='if select, randomly choose starting points each time performing pgd',default=True)
    ...
    # parser.add_argument('--state', type=str, default='gen', help='which state this exp currently in')
    
    parser.add_argument("--exp_name", type=str, default="ID-UNK")
    parser.add_argument('--exp_hyper', type=str, default='hyper-unk', help='which hyperparameters this exp currently using')
